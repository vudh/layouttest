...
(function ($, window, document, undefined) {
    ...
    jQuery.widget("mobile.scrollview", jQuery.mobile.widget, {
        ...
        _handleDragStart: function (e, ex, ey) {
            ...
            // Comment this for enable wipe events
            if (this.options.eventType == "mouse" || this.options.delayedClickEnabled)
                e.preventDefault();
            //e.stopPropagation();
            if (checkX != "undefine" && checkX == ex) {
                e.stopPropagation();
            }

            // Bubble scroll start event
        ...
        _handleDragStop: function (e) {
            ...
            // Bubble scroll start event
            if (this.options.onScrollEnd) this.options.onScrollEnd.call(this, e);
