    ...
    $.extend($.jqx._jqxGrid.prototype, {
        _initpager: function () {
            ...
            if (!this.pagerrenderer) {
                ...
                var leftarrow = $("<div style='width: 27px; height: 13px;'></div>");
                leftarrow.addClass(this.toThemeProperty('icon-arrow-left'));
                this.pagerleftbutton.wrapInner(leftarrow);

                var rightarrow = $("<div style='width: 27px; height: 13px;'></div>");
        ...
        gotopage: function (pagenum) {
            ...
            var pages = Math.ceil(this.dataview.totalrecords / this.pagesize);
            if (pagenum >= pages) {
        ...
        updatepagerdetails: function () {
            if (this.pagerdetails != null && this.pagerdetails.length > 0) {
                ...
                var pagescount = Math.round(this.dataview.totalrecords / this.dataview.pagesize);
                ...
                this.pagerdetails[0].innerHTML = currentrecord + '-' + lastrecord + this.gridlocalization.pagerrangestring + this.dataview.totalrecords;
